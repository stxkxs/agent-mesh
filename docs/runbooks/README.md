...
Future runbooks land here as new failure modes surface in operation — latency spikes, MCP gateway outages, cache poisoning, audit pipeline lag, key rotation failures, eval regressions, DLQ redrive.
